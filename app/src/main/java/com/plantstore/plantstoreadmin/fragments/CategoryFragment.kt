...
import com.plantstore.plantstoreadmin.adapter.CategoryAdapter
import com.plantstore.plantstoreadmin.databinding.FragmentCategoryBinding
...
class CategoryFragment : Fragment() {
    ...
    private fun uploadImage(categoryName: String) {
        ...
        val refStroage = FirebaseStorage.getInstance().reference.child("category/$fileName")
        refStroage.putFile(imageUrl!!)
